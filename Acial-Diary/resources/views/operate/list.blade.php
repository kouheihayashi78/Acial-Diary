        ...
        <table class="table table-bordered table-hover dataTable dtr-inline" role="grid">
            <thead>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('operate.detail', $row->id)}}" class="btn btn-outline-primary">詳細</a>
                        <a href="{{route('operate.update', $row->id)}}" class="btn btn-outline-primary">編集</a>
                        <a href="{{route('operate.delete.confirm', $row->id)}}" class="btn btn-outline-primary">削除</a>
                    </td>
                </tr>
                @endforeach
            </thead>
