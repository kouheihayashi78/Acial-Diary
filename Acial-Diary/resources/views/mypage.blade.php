    ...
    <div class="row">
        <div class="col-8 offset-2 bg-white">
            ...
            <form method="POST" action="{{ route('edit-profile') }}" class="p-5" enctype="multipart/form-data">
                ...
                {{-- アバター画像 --}}
                <span class="avatar-form image-picker justify-center">
                    <input type="file" name="icon" class="d-none" accept="image/png,image/jpeg,image/gif" id="icon" />
                    <label for="icon" class="d-inline-block">
                        @if (!empty($user->icon))
                        <img src="/storage/icons/{{$user->icon}}" class="rounded-circle" style="object-fit: cover; width: 200px; height: 200px;">
                        @else
